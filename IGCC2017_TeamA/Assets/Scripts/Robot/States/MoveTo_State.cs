...
public class MoveTo_State : Robot_BaseState
{
    ...
    public override void Update()
    {
        ...
        main_robot.GetComponent<Rigidbody2D>().velocity = new Vector2(robot_direction.x * (main_robot.GetComponent<Robot_Status>().GetSpeedPoint() * 10) * Time.deltaTime
            , robot_direction.y * (main_robot.GetComponent<Robot_Status>().GetSpeedPoint() * 10) * Time.deltaTime);
