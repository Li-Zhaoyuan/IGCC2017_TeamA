//************************************************/
//* @file  :RoamMonsterAttackState.cs
//* @brief :徘徊するモンスターの攻撃状態
...
public class RoamMonsterAttackState : State<RoamMonster>
{
	public RoamMonsterAttackState(RoamMonster obj) : base(obj) { }
